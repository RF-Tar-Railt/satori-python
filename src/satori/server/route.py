from typing import Any, Awaitable, Callable, Union, Dict, List, TypeVar, Protocol
from typing_extensions import TypeAlias, TypedDict, NotRequired
from satori.model import ModelBase, MessageObject, PageResult, Channel, Guild, Role, Member, User, Login
...
INTERAL: TypeAlias = Router[Any, Union[ModelBase, List[ModelBase], Dict[str, Any], List[Dict[str, Any]], None]]
